...
--
-- Host: localhost
-- Generation Time: Apr 10, 2017 at 04:19 PM
...
-- Database: `cambuz`
--
CREATE DATABASE `cambuz` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cambuz`;
...
INSERT INTO `comment` (`id`, `body`, `date_added`, `added_by`, `user_posted_to`, `pid`) VALUES
(14, 'sad', '2017-03-24', 'root', 'test123', 86),
(23, 'aa', '2017-04-10', 'kkanandhu', 'test123', 94),
(20, 'hi', '2017-03-26', 'root', 'test123', 91),
(21, 'aaaa', '2017-03-27', 'root', 'test123', 92),
(22, 'ss', '2017-03-31', 'root', 'test123', 92);
...
INSERT INTO `dynamic` (`id`, `username`, `body`, `dynamic_pic`, `date_added`, `added_by`, `user_posted_to`) VALUES
(78, 'root', 'om nama: sivayaa', 'yTZ1EbaJRIvcVme/download.jpg', '2017-03-13', 'root', 'test123'),
(79, 'root', '', 'EkXQbfNLhVxw5Rt/download.jpg', '2017-03-13', 'root', 'test123'),
(82, 'root', '', 'Y8QypfbwihIBkA7/b1.PNG', '2017-03-19', 'root', 'test123'),
(83, 'root', '', '8rOnahI9S0J3kFA/_heart__of__ice___by_fridaythe13th.jpg', '2017-03-19', 'root', 'test123'),
(88, 'root', 'om nama: sivayaa', 'vaN517n6OIKG4F0/download.jpg', '2017-03-19', 'root', 'test123');
...
INSERT INTO `forum_posts` (`id`, `body`, `date_added`, `added_by`, `user_posted_to`) VALUES
(34, 'pokpokpk', '2017-04-10', 'kkanandhu', 'test123'),
(33, 'aaaa', '2017-03-27', 'root', 'test123'),
(32, 'aaa', '2017-03-27', 'rkrishnashankar', 'test123'),
(28, ' sss', '2017-03-25', 'root', 'test123');
...
CREATE TABLE IF NOT EXISTS `likes` (
  ...
  `pid` int(10) NOT NULL,
  `like_by` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
...
INSERT INTO `likes` (`id`, `like`, `pid`, `like_by`) VALUES
(38, 0, 92, 'root'),
(35, 0, 91, 'rkrishnashankar'),
(39, 0, 92, 'rkrishnashankar');
...
INSERT INTO `posts` (`id`, `body`, `date_added`, `added_by`, `user_posted_to`, `like1`) VALUES
(91, 'aaa', '2017-03-26', 'root', 'test123', 1),
(92, 'qwerty\r\n', '2017-03-27', 'root', 'test123', 2),
(93, 'haha', '2017-04-10', 'kkanandhu', 'test123', 0),
(94, 'okok', '2017-04-10', 'kkanandhu', 'test123', 0);
...
INSERT INTO `replay` (`id`, `body`, `date_added`, `added_by`, `user_posted_to`, `fid`) VALUES
(1, 'its nice idea', '2017-03-25', 'root', 'test123', 28),
(2, 'aaa\r\n', '2017-03-26', 'root', 'test123', 30),
(3, 'aa', '2017-03-27', 'root', 'test123', 33),
(4, 'ijiji', '2017-04-10', 'kkanandhu', 'test123', 34);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `profile_pic` text,
  `friend_array` text,
  `semster` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `username`, `first_name`, `last_name`, `email`, `password`, `sign_up_date`, `activated`, `bio`, `profile_pic`, `friend_array`, `semster`, `department`) VALUES
(8, 'root', 'asd', 'asd', 'kkanandhu@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '2017-03-05', '1', 'aaaaaaaaaaaaa', 'LyE5zBaeVUs0kNC/WIN_20170206_15_32_41_Pro.jpg', NULL, 's3', 'cse'),
(9, 'rkrishnashankar', 'Krishnashankar', 'R', 'kichanz007@gmail.com', 'e77dc2e0072df3f4330cd1c0f1d9718c', '2017-03-13', NULL, NULL, '4RpBxNvT0blQKr6/login.PNG', NULL, NULL, NULL),
(10, 'kkanandhu', 'Anandhu', 'kk', 'kkanandhu97@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '2017-04-10', NULL, 'om nama: sivaya', 'w0BipcEMLA54K61/butterfly-1920x1080.jpg', NULL, '6', 'cse');
--
...
('def', 'cambuz', 'comment', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'comment', 'body', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'comment', 'date_added', 3, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'comment', 'added_by', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'comment', 'user_posted_to', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'comment', 'pid', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'username', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'body', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'dynamic_pic', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'date_added', 5, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'added_by', 6, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'dynamic', 'user_posted_to', 7, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'forum_posts', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'forum_posts', 'body', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'forum_posts', 'date_added', 3, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'forum_posts', 'added_by', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'forum_posts', 'user_posted_to', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'likes', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'likes', 'like', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'likes', 'pid', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'likes', 'like_by', 4, NULL, 'YES', 'varchar', 250, 250, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(250)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'body', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'date_added', 3, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'added_by', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'user_posted_to', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'posts', 'like1', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'body', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'date_added', 3, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'added_by', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'user_posted_to', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'replay', 'fid', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'username', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'first_name', 3, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'last_name', 4, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'email', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'password', 6, NULL, 'YES', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'sign_up_date', 7, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'activated', 8, NULL, 'YES', 'enum', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''0'',''1'')', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'bio', 9, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'profile_pic', 10, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'friend_array', 11, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'semster', 12, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'cambuz', 'users', 'department', 13, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
...
('BINLOG_STMT_CACHE_USE', '21'),
('BYTES_RECEIVED', '44796'),
('BYTES_SENT', '402045'),
...
('HANDLER_READ_KEY', '173'),
('HANDLER_READ_LAST', '2'),
('HANDLER_READ_NEXT', '17'),
('HANDLER_READ_PREV', '6'),
('HANDLER_READ_RND', '86'),
('HANDLER_READ_RND_NEXT', '4911'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '20'),
('HANDLER_WRITE', '3874'),
('INNODB_BUFFER_POOL_PAGES_DATA', '342'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '196'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7849'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '5172'),
('INNODB_BUFFER_POOL_READS', '343'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '250'),
('INNODB_DATA_FSYNCS', '98'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '7802880'),
('INNODB_DATA_READS', '353'),
('INNODB_DATA_WRITES', '175'),
('INNODB_DATA_WRITTEN', '3253760'),
('INNODB_DBLWR_PAGES_WRITTEN', '98'),
('INNODB_DBLWR_WRITES', '20'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '27'),
('INNODB_LOG_WRITES', '37'),
('INNODB_OS_LOG_FSYNCS', '57'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '32256'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '0'),
('INNODB_PAGES_READ', '342'),
('INNODB_PAGES_WRITTEN', '98'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '3231'),
('UPTIME_SINCE_FLUSH_STATUS', '3231');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-LTI5EF5.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-LTI5EF5.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-LTI5EF5-slow.log'),
...
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'comment', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'dynamic', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'forum_posts', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'likes', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'id', 'def', 'cambuz', 'likes', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'posts', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'replay', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'cambuz', 'PRIMARY', 'def', 'cambuz', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-04-10 16:19:16', NULL, NULL, NULL, '', '', NULL),
('def', 'cambuz', 'comment', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 50, 656, 281474976710655, 2048, 404, '2017-03-24 19:02:08', '2017-03-31 14:14:39', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'dynamic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 85, 1256, 281474976710655, 2048, 828, '2017-03-05 07:13:00', '2017-03-24 19:05:43', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'forum_posts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 57, 576, 281474976710655, 2048, 348, '2017-03-13 04:56:46', '2017-03-27 08:41:48', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'likes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 38, 140, 281474976710655, 3072, 24, '2017-03-25 10:59:31', '2017-04-10 16:08:16', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'posts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 46, 552, 281474976710655, 2048, 368, '2017-03-24 20:54:58', '2017-04-10 16:14:48', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'replay', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 40, 160, 281474976710655, 2048, 0, '2017-03-25 15:14:47', '2017-04-10 16:07:38', NULL, NULL, '', '', NULL),
('def', 'cambuz', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 7340032, '2017-03-04 04:19:28', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 13:45:10', '2012-04-19 10:15:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, NULL, '', '', NULL),
...
(177, 'root', 'localhost:60448', 'cambuz', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'cambuz', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '5193'),
('INNODB_BUFFER_POOL_READS', '343'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '250'),
('INNODB_DATA_FSYNCS', '98'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '3232'),
('UPTIME_SINCE_FLUSH_STATUS', '3232');
...
('def', 'cambuz', 'comment', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'dynamic', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'forum_posts', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'likes', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'likes', 0, 'cambuz', 'id', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'posts', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'replay', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'cambuz', 'users', 0, 'cambuz', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-04-10 16:19:16', '2017-04-10 16:19:16', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-04-10 16:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'cambuz', 'comment', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 50, 656, 281474976710655, 2048, 404, 24, '2017-03-24 19:02:08', '2017-03-31 14:14:39', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'dynamic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 85, 1256, 281474976710655, 2048, 828, 103, '2017-03-05 07:13:00', '2017-03-24 19:05:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'forum_posts', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 57, 576, 281474976710655, 2048, 348, 35, '2017-03-13 04:56:46', '2017-03-27 08:41:48', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'likes', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 38, 140, 281474976710655, 3072, 24, 43, '2017-03-25 10:59:31', '2017-04-10 16:08:16', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'posts', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 46, 552, 281474976710655, 2048, 368, 97, '2017-03-24 20:54:58', '2017-04-10 16:14:48', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'replay', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 40, 160, 281474976710655, 2048, 0, 5, '2017-03-25 15:14:47', '2017-04-10 16:07:38', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'cambuz', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 7340032, 11, '2017-03-04 04:19:28', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 13:45:10', '2012-04-19 10:15:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 10:15:10', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'cambuz', 'PRIMARY', 'cambuz', 'comment', 'PRIMARY KEY'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'dynamic', 'PRIMARY KEY'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'forum_posts', 'PRIMARY KEY'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'likes', 'PRIMARY KEY'),
('def', 'cambuz', 'id', 'cambuz', 'likes', 'UNIQUE'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'posts', 'PRIMARY KEY'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'replay', 'PRIMARY KEY'),
('def', 'cambuz', 'PRIMARY', 'cambuz', 'users', 'PRIMARY KEY'),
