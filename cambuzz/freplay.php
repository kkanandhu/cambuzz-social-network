...
$sqlCommand = "INSERT INTO replay(body,date_added,added_by,user_posted_to,fid)  VALUES ('$post','$date_added','$added_by','$user_posted_to','$txt')";  
	...
	<form  method="POST" action=""  >
			...
			<div class="container">
			  <div class="row">
			    ...
			    <textarea id="post" name="post" rows="2" cols="60" style="height: 100%"     ></textarea>
			    </div>
...
$getposts = mysqli_query($conn,"SELECT * FROM replay WHERE fid='$txt' ORDER BY id DESC LIMIT 10") or die(mysql_error());
