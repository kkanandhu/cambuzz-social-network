...
$getposts = mysqli_query($conn,"SELECT * FROM posts  ORDER BY id DESC LIMIT 10") or die(mysql_error());
...
<div class='author-box z-depth-1' >
    ...
    <div class='row' style='padding: 20px;''>
        ...
        <div class='col-12 col-sm-10'>
         ...
         <a href='./like.php?id=$id'> <img src='./img/like.png'style='height=30px;width:30px; /></a>
         ...
         <a href='./comment.php?id=$id'><b> comment </b></a>
         </div>
